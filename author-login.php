  ...
  <div class="forms-container">
    ...
    <div class="left">
      <div class="form-title">
        <h4>Login</h4>
        <p>If you've already registered login!</p>
      </div>
    ...
    <div class="right">
      ...
      <div class="form-errors d-flex">
        <p class="errors" id="signup-errors">
          Password must be 6 to 20 characters long with at least 1 number, 1 uppercase and 1 lowercase
        </p>
      </div>
    </div>
  </div>
