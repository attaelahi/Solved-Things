...
<head>
  ...
  <!-- FAVICON LINK -->
  <link rel="icon" href="./assets/images/top.ico" type="image/x-icon" />

  <!-- TITLE OF THE PAGE -->
  <title>SolvedThings | <?php echo $page_title; ?></title>
...
<body>
  ...
  <!-- ======== NAVBAR ======== -->
  <nav class="navbar">
    <div class="logo"><a href="./index.php"><img src="./assets/images/loga.png" /></a></div>
    ...
    <ul class="ul">
      ...
      <li>
        ...
        <ul>
          ...
          <li><a href="./author-login.php">Upload Your Content</a></li>
        </ul>
      </li>
      <?php
        }
